...
namespace PolySpatial.Samples
{
    ...
    public class HandTip
    {
        ...
        public float m_MinimumHoldTime = 0.2f;
        public string tip;
    ...
    {
        public HandTip[] handTips;
        [SerializeField]
        UpdateHandTipText m_UpdateHandTipText;
        public float m_GestureDetectionInterval = 0.1f;
        ...
        void Start()
        {
            ...
            foreach (var ht in handTips)
            {
                ht.Init(() =>
                {
                    m_UpdateHandTipText.UpdateTipsText(ht.tip);
                });
            }
        }
        ...
        void Update()
        {
            ...
            {
                m_HandJointsUpdatedEventArgs.hand = m_HandSubsystem.leftHand;
                TryCheck();
                // assign joint values
        ...
        void TryCheck()
        {
            ...
            if (Time.timeSinceLevelLoad > m_TimeOfLastConditionCheck + m_GestureDetectionInterval)
            {
                ...
                foreach (var ht in handTips)
                {
                    ht.CheckHand(m_HandJointsUpdatedEventArgs);
                }
            }
        }
