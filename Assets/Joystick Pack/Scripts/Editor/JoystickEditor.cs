...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty onXDrag;
    private SerializedProperty onYDrag;
    ...
    protected virtual void OnEnable()
    {
        ...
        onXDrag = serializedObject.FindProperty("onXDrag");
        onYDrag = serializedObject.FindProperty("onYDrag");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(onXDrag, new GUIContent("OnXDrag", "The background's RectTransform component."));
        EditorGUILayout.PropertyField(onYDrag, new GUIContent("OnYDrag", "The handle's RectTransform component."));
