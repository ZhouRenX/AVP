...
public class AzureSpeech : MonoBehaviour
{
   public AudioSource audioSource;
    ...
    //Azure语音服务的秘钥
    [Header("输入Azure语音服务的令牌")]
    [SerializeField]public string SubscriptionKey = "输入微软语音服务的资源秘钥（注册Azure创建服务后获得）";
    //服务所在区域
    [Header("输入Azure语音服务所在区域的编码")]
    [SerializeField] public string Region = "YourServiceRegion";
    //语音设置
    [Header("设置声音的角色码")]
